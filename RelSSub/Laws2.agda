...
-- ^<>T^^ U[]        U[]        U[]        u𝒢 = U[]
-- ^<>T^^ (El[] t𝒢₁) (El[] t𝒢₂) (El[] t𝒢₃) u𝒢 = El[] (^<>^^ t𝒢₁ t𝒢₂ t𝒢₃ u𝒢)
-- ^<>T^^ (Π[] A𝒢₁ B𝒢₁) (Π[] A𝒢₂ B𝒢₂) (Π[] A𝒢₃ B𝒢₃) u𝒢 
--   = Π[] (^<>T^^ A𝒢₁ A𝒢₂ A𝒢₃ u𝒢) 
--         (^<>T^^ {Ξ𝒢₂ = ▷[] _ _} {Ξ𝒢₄ = ▷[] _ _} B𝒢₁ B𝒢₂ B𝒢₃ u𝒢)
...
-- ^<>^^ {q = T} δ (lam[] {A𝒢 = A𝒢₁} t𝒢₁) (lam[] {A𝒢 = A𝒢₂} t𝒢₂) (lam[] {A𝒢 = A𝒢₃} t𝒢₃) u𝒢 
--   = {!lam[] {A𝒢 = ^<>T^^ A𝒢₁ A𝒢₂ A𝒢₃ u𝒢} (^<>^^ {Ξ𝒢₂ = ▷[] _ _} t𝒢₁ t𝒢₂ t𝒢₃ u𝒢)!}
-- ^<>^^ {q = T} δ (app[] {B𝒢₂ = B𝒢₁} t𝒢₁ u𝒢₁) 
--       (app[] {B𝒢₂ = B𝒢₂} t𝒢₂ u𝒢₂) 
--       (app[] {B𝒢₂ = B𝒢₃} t𝒢₃ u𝒢₃) v𝒢 
--   = {!!} 
--   -- app[] {B𝒢₂ = ^<>T^^ {Ξ𝒢₂ = ▷[] _ _} B𝒢₁ B𝒢₂ B𝒢₃ v𝒢} 
--   --         {!^<>^^ t𝒢₁ t𝒢₂ t𝒢₃ v𝒢!} {!^<>^^ u𝒢₁ u𝒢₂ u𝒢₃ v𝒢!}
...
--       (vs^ {i = i} {i[] = i[]₁} i𝒢₁ i[]𝒢₁) (vs^ {i[] = i[]₂} i𝒢₂ i[]𝒢₂) i𝒢₃ u𝒢 
--   using i[]𝒢s₁ ← wk^^^ {t = i[]₁} (δ ^^ _)
--                        {Ξ𝒢₁ = •[]} {Ξ𝒢₂ = •[]} {Ξ𝒢₃ = •[]} {Ξ𝒢₄ = •[]} 
--                        i[]𝒢₁ i𝒢₃
--       | i𝒢s    ← ^<>^^ {t = i} δ 
